...
const AboutCars = () => {
  return (
    <div className="bg-black p-[4rem]  flex flex-col items-center mt-[8rem] text-white gap-10 mx-auto">
      ...
      <div className="flex  gap-5  ">
        <div className="flex  flex-col items-center gap-2 w-[384px] mx-auto">
          <span className="w-8 h-8 rounded-full bg-white text-black text-md flex justify-center items-center">
            <BsStars />
          </span>
